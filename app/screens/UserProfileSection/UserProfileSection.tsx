  ...
  return (
    <section className="flex flex-col w-full items-center gap-6 px-[100px] py-20 relative max-[1100px]:px-[50px] max-[1300px]:px-[80px] max-[767px]:px-[25px] max-[1000px]:py-10">
      <div className="flex items-end justify-between max-[800px]:flex-wrap max-[800px]:gap-4 relative self-stretch w-full">
        <h2 className="relative w-[507px] max-[800px]:w-[100%] font-Plus_Jakarta_Sans font-semibold text-left  text-[#050912] text-[48px] max-[1100px]:text-[44px] max-[1000px]:text-[36px] max-[767px]:text-[28px] text-center tracking-[-0.2px] leading-[120%]">
          Used by various roles in various companies
        </h2>

        <p className="relative w-[501px] max-[800px]:w-[100%] font-regular max-[800px]:text-left  text-[#6d6d6d]  font-Plus_Jakarta_Sans tracking-[-0.2px] leading-[180%] text-[14px] max-[1000px]:text-[12px] text-right">
      ...
      <div className="marquee w-full max-w-[1200px] px-0 py-12 max-[1000px]:py-10 max-[800px]:py-6 relative bg-[#f6f6f6] rounded-[16px]">
